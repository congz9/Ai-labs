...
async function test() {
  try {
    ...
    const imgRes = await fetch('https://img.vietqr.io/image/970407-0987654321-compact2.jpg');
    console.log('VietQR Image status for Techcombank (as reference):', imgRes.status);
